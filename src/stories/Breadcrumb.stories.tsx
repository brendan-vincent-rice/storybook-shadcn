  ...
  render: () => (
    <Breadcrumb>
      <BreadcrumbList>
        ...
        <BreadcrumbSeparator />
        <BreadcrumbItem>
          <BreadcrumbLink href="/dashboard/projects/web-app">Web App</BreadcrumbLink>
        </BreadcrumbItem>
        <BreadcrumbSeparator />
        <BreadcrumbItem>
          <BreadcrumbLink href="/dashboard/projects/web-app/components">Components</BreadcrumbLink>
        </BreadcrumbItem>
        <BreadcrumbSeparator />
        <BreadcrumbItem>
  ...
  render: () => (
    <Breadcrumb>
      <BreadcrumbList>
        ...
        <BreadcrumbSeparator />
        <BreadcrumbItem>
          <BreadcrumbPage>MacBook Pro 14-inch</BreadcrumbPage>
        </BreadcrumbItem>
      </BreadcrumbList>
    </Breadcrumb>
  ),
  ...
  render: () => (
    <Breadcrumb>
      <BreadcrumbList>
        ...
        <BreadcrumbItem>
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start">
              ...
              <DropdownMenuItem>
                <BreadcrumbLink href="/docs/components/ui">UI Components</BreadcrumbLink>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </BreadcrumbItem>
        <BreadcrumbSeparator />
        <BreadcrumbItem>
          <BreadcrumbLink href="/docs/components/ui/navigation">Navigation</BreadcrumbLink>
        </BreadcrumbItem>
        <BreadcrumbSeparator />
        <BreadcrumbItem>
          <BreadcrumbPage>Breadcrumb</BreadcrumbPage>
